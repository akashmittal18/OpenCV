...
ball = img[280:340, 330:390]    # copies the particular element of an image
...
dst = cv2.add(img, img2)   # Adds two images

#dst = cv2.addWeighted(img, .9,  img2, .1, 0)  #gives a weighted image
